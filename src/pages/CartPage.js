          ...
          <div className="container">
            ...
            <div className="row">
              <div style={{ wordSpacing: 1, lineHeight: 1 }} className="">
                {cart?.map((p) => (
                  <div key={p._id} className="d-flex mb-3 lg:p-5 p-2 align-items-center justify-content-between bg-light " >
                    {/* product image */}
                    <div>
                      <img
                    ...
                    <div className="w-50">
                      <p>{p.name}</p>
                      <p>Size: M</p>
                      <p className="price mb-2">{p.price * (quantities[p._id] || 1)} Taka</p>
