    ...
    <Layout title="Login-Eccha-Nir">
      ...
      <div className="form-container" style={{ minHeight: "90vh" }} >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p className='d-flex justify-content-end mt-2 decoration-none'><a href="/forgot-password">Forgot Password </a></p>
          <p>I have no Account <a href="/register"> please Register</a></p>
        </form>
