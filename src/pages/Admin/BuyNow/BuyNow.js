...
//   console.log(productNumber);
  ...
  const handleCreateOrder = async (e) => {
    ...
    //   productData.append('photo',   );
      ...
      const { data } = await Axios.post('/api/v1/order/create-order', productData);
      if (data?.success) {
            ...
            <div>
                ...
                <div className='border container'>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                            <img height={100} className='brand-image' src={`/api/v1/product/product-photo/${orderData._id}`} alt="" />
                    ...
                    <td>: {size}</td>
                            ...
                            <tr>
                                ...
                                <p className='border d-flex justify-content-between pt-2 pb-0 '>  <p onClick={handleDecrease}>-</p>
                                {quantities}
                            ...
                            <tr>
                                <td><p className='fw-medium'>Price</p></td>
                                <td  className='fw-medium'><p className="price "> : {orderData.price} Tk</p></td>
                            </tr>
                            <tr>
                                <td><p className='fw-medium'>Sub Total</p></td>
                                <td>< p className='fw-medium'> : {orderData.price *quantities} Tk</p></td>
                            </tr>
